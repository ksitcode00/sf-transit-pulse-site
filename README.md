...
The Analytics area complements live trip planning. Features 1–3 (Route Map, Reliability, and Best Time) are available in the web Analytics view, built from the latest complete month of historic Muni trips and 511 stop observations; the site automatically replaces that month after new official data is available, while the underlying tables remain ready for Tableau exploration. Feature 4 is a **research preview**, collecting predictions for routes **1, 8, 30, and 45** and waiting for official monthly observed arrivals before reporting errors. Feature 5 maps street-work context; Feature 6 is collecting alert history; Feature 7 explores official injury-crash history with weekly source checks. Feature 8 explores anonymized police incident history near current Muni stops with daily source checks. Calibration models and validated uncertainty intervals are not yet implemented.

[Explore incident history](https://ksitcode00.github.io/sf-transit-pulse-site/analytics/?lang=en#incident-environment) · [Download Feature 8 data](https://ksitcode00.github.io/sf-transit-pulse-site/data/tableau/feature8_incident_environment.zip) · [Methodology](docs/incident-environment.md)

Feature 8 includes route/stop/month/category/day-night filters, 100–400 m approximate stop buffers, anonymized location maps, category breakdowns and monthly trends. Reports are deduplicated by incident ID; categories and nearby stops can overlap. History is descriptive context, not a safety ranking or personal-risk forecast.
